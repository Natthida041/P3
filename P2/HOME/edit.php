...
<body>
    ...
    <header class="header">
        <h1>แก้ไข</h1>
        <nav class="nav">
            <a href="/P2/HOME/manage/news_detail.php?id=<?= $article_id ?>">← กลับไปหน้ารายละเอียดบทความ</a>
        </nav>
    </header>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <?php foreach ($pdf_files as $media): ?>
                <div class="media-item">
                    ...
                    <button type="submit" name="delete_media_<?= $media['id'] ?>" class="delete-btn">ลบไฟล์นี้</button>
                </div>
            <?php endforeach; ?>
            ...
            <?php foreach ($video_files as $media): ?>
                <div class="media-item">
                    ...
                    <button type="submit" name="delete_media_<?= $media['id'] ?>" class="delete-btn">ลบวิดีโอนี้</button>
                </div>
            <?php endforeach; ?>
            ...
            <?php foreach ($image_files as $media): ?>
                <div class="media-item">
                    ...
                    <button type="submit" name="delete_media_<?= $media['id'] ?>" class="delete-btn">ลบรูปภาพนี้</button>
                </div>
            <?php endforeach; ?>
